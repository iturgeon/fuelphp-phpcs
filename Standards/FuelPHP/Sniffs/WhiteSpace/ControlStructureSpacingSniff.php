...
class ControlStructureSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        {
            $error = 'A space need to be set between control strucure and opening parenthesis';
            $phpcsFile->addError($error, $stackPtr, 'ControlStructureSpacingSniff');
        }
        ...
        if (isset($tokens[$stackPtr]['parenthesis_opener']) === true) {
            ...
            if ($tokens[($parenOpener + 1)]['code'] === T_WHITESPACE && $tokens[($parenOpener + 2)]['code'] !== T_BOOLEAN_NOT) {
